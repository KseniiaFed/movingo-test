...
const Hero = () => {
  return (
    <div className="bg-hero-image bg-cover bg-center">
      <div className="bg-black p-44 bg-opacity-40 justify-center flex items-center h-full w-full">
        <div className="flex flex-col text-white font-semibold w-auto">
          <span className="text-3xl tracking-wide">
            Designed to sell your home for more
          </span>
          <span className="mb-6 tracking-wide text-lg">
            Technology in the cloud. Experts on the ground
          </span>
          <div className="flex flex-row space-x-8 w-auto py-4 px-5 rounded justify-center bg-white">
            <label
              htmlFor="locationInput"
              className="flex items-center border-b border-teal"
            >
              <input
                id="locationInput"
                type="text"
            ...
            <label
              htmlFor="dateInput"
              className="flex items-center border-b-0.5 border-teal"
            >
              <input
                id="dateInput"
                type="text"
